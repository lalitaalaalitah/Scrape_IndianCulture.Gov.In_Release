...
main_dict = {
    ...
    "OtherCollection" : [
        '/Volumes/14TB_EXOS_28102020/lalitaalaalitah/Documents/Github/Scrape_IndianCulture.Gov.In/OtherCollections',
        'https://www.indianculture.gov.in/other-collections?search_api_fulltext=&page=',
        'https://www.indianculture.gov.in/other-collections?search_api_fulltext=&page=0'
    ]
}
# 
